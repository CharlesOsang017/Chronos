...
const ProjectDetails = () => {
  ...
  const [isTaskFilter, setIsTaskFilter] = useState<TaskStatus | "All">("All");
      ...
      <div className='flex items-center justify-between'>
        <Tabs defaultValue='all' className='w-full'>
          <div className='flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6'>
            <TabsList>
              <TabsTrigger value='all' onClick={() => setIsTaskFilter("All")}>
                All Tasks
              </TabsTrigger>
              <TabsTrigger
                value='todo'
                onClick={() => setIsTaskFilter("To Do")}
              >
                Todo
              </TabsTrigger>
              <TabsTrigger
                value='in-progress'
                onClick={() => setIsTaskFilter("In Progress")}
              >
                In Progress
              </TabsTrigger>
              <TabsTrigger value='done' onClick={() => setIsTaskFilter("Done")}>
                Done
              </TabsTrigger>
            </TabsList>
      ...
      <CardContent>
        ...
        {task.subtask && task.subtask.length > 0 && (
          <div className="mt-2 text-xs text-muted-foreground">
            {task.subtask.filter((subtask) => subtask.completed).length} / {task.subtask.length} subtasks        
          </div>
        )}
      </CardContent>
    </Card>
